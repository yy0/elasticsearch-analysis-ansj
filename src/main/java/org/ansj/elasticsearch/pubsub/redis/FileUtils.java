...
public class FileUtils {
    ...
    public static void remove(String content) {
        try {
            File file = new File(AnsjElasticConfigurator.environment.configFile().toString(), "ansj/user/ext.dic");
    ...
    public static void removeAMB(String content) {
        try {
            File file = new File(AnsjElasticConfigurator.environment.configFile().toString(), "ansj/ambiguity.dic");
